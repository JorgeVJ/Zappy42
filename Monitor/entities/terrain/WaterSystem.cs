...
// Mar procedural alrededor del terreno. Sigue el mismo patrón que GrassSystem /
...
public partial class WaterSystem : Node3D
{
	...
	[Export] public float PlaneSize = 600f;
	...
	public override void _Ready()
	{
		...
		// impactando el terreno → la selección de tile no cambia.
	...
	public void Generate(float[,] heightMap, int width, int height)
	{
		...
		// Plano sin subdivisión: el movimiento de superficie va entero en el fragment.
		...
		// Posición inicial centrada en el mapa; _Process lo mantiene bajo la cámara.
	...
	public override void _Process(double delta)
	{
		...
		// patrón → se ve continuo y sin bordes.
