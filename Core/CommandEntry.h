...
struct CommandEntry
{
    ...
    /// <summary>
    /// Crea un CommandEntry con los ticks calculados automáticamente
    /// </summary>
    /// <param name="cmdType">Tipo de comando</param>
    /// <param name="param">Parámetro del comando (vacío si no tiene)</param>
    ...
    /// <summary>
    /// Sobrecarga para comandos sin parámetros
    /// </summary>
